...
<div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 p-6 sm:align-middle sm:max-w-screen-md sm:w-full"
                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text"
                                ...
                                placeholder="Enter Title" wire:model="page.title">
                            @error('page.title') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                                @if ($page->featured)
                                Thumbnail Preview:
                                    <img src="{{ $page->featuredUrl() }}">
                                @endif
                                ...
                                <div class="block text-gray-700 _text-sm font-bold mb-2"> <span>Thumbnail</span>
                                    <div class="relative h-40 rounded-lg border-dashed border-2 border-gray-200 bg-white flex justify-center items-center hover:cursor-pointer">
                                        ...
                                        </div> <input type="file" class="h-full w-full opacity-0" name="" wire:model="featured">
                                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="text"
                                class="rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                placeholder="Content" wire:model="page.description">{!! $page->description !!}</textarea>
                                <div class="mt-2 bg-white hidden" wire:ignore>
                                    <div
                                         x-data
                                         x-ref="quillEditor"
                                         x-init="
                            ...
                            @error('page.description') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <input type="hidden" wire:model="page.id" >
